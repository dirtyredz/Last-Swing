...
| Detect killing blows on rocks/ore after they leave the grid | ✅ | Shipped in 1.0.1 (`pendingDestructibleCheck`). Owner-tested in game 2026-08-22 ("all good"). |
...
**Released:** v1.0.1 on Nexus ([mod 122](https://www.nexusmods.com/moonlightpeaks/mods/122)) — the
rock/ore killing-blow fix. v1.0.0 was the first release.
